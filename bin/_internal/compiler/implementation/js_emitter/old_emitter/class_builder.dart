...
class ClassBuilder {
  ...
  jsAst.ObjectInitializer toObjectInitializer() {
    ...
    if (fieldMetadata != null) {
      ...
      classData = new jsAst.ArrayInitializer.from([classData]..addAll(fieldMetadata));
    }
    var fieldsAndProperties = [new jsAst.Property(js.string(namer.classDescriptorProperty), classData)]..addAll(properties);
