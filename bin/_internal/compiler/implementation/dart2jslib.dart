...
import 'elements/modelx.dart' show ErroneousElementX, ClassElementX, CompilationUnitElementX, LibraryElementX, PrefixElementX, VoidElementX, AnalyzableElement, DeferredLoaderGetterElementX;
...
export 'scanner/scannerlib.dart' show isUserDefinableOperator, isUnaryOperator, isBinaryOperator, isTernaryOperator, isMinusOperator;
export 'universe/universe.dart' show Selector, TypedSelector;
export 'util/util.dart' show Spannable, CURRENT_ELEMENT_SPANNABLE, NO_LOCATION_SPANNABLE;
