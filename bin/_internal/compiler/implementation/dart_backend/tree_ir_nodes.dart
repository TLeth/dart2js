...
class InvokeConstructor extends Expression implements Invoke {
  ...
  InvokeConstructor(this.type, this.target, this.selector, this.arguments, [this.constant]);
...
class FunctionDefinition extends Node {
  ...
  FunctionDefinition(this.element, this.parameters, this.body, this.localConstants, this.defaultParameterValues);
...
abstract class Visitor<S, E> implements ExpressionVisitor<E>, StatementVisitor<S> {
  E visitExpression(Expression e) => e.accept(this);
  S visitStatement(Statement s) => s.accept(this);
}
