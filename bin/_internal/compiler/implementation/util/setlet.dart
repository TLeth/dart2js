...
class Setlet<E> extends IterableBase<E> implements Set<E> {
  ...
  Setlet<E> intersection(Set<E> other) => new Setlet<E>.from(this.where((e) => other.contains(e)));

  Setlet<E> difference(Set<E> other) => new Setlet<E>.from(this.where((e) => !other.contains(e)));
