...
import '../closure.dart' show ClosureClassElement, ClosureClassMap, ClosureFieldElement, CapturedVariable;

import '../dart_types.dart' show TypedefType;

import '../dart2jslib.dart' show CodeBuffer;
...
import '../js/js.dart' show js, templateManager;

import '../js_backend/js_backend.dart' show CheckedModeHelper, ConstantEmitter, CustomElementsAnalysis, JavaScriptBackend, JavaScriptConstantCompiler, Namer, NativeEmitter, RuntimeTypes, Substitution, TypeCheck, TypeChecks, TypeVariableHandler;
...
import '../source_file.dart' show SourceFile, StringSourceFile;
