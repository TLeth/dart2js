 ...
 *
 */
String _bytesToBase64(List<int> bytes, {bool urlSafe: false, bool addLineSeparator: false}) {
...
abstract class _HashBase implements Hash {
  ...
  _HashBase(int chunkSizeInWords, int digestSizeInWords, bool this._bigEndianWords)
      : _pendingData = [],
